/*
  ...
  1. New Features
    ...
    - Update role constraints to include 'admin'
    - Create admin profile creation function and trigger
    - Add admin policies for full system access

  2. Security
    - Enable admin access to all tables
    - Maintain existing RLS policies for regular users
    - Auto-create admin profile for rayannyrego@gmail.com

  3. Changes
    - Modified user_profiles table structure
    - Added admin-specific policies
    - Created automatic admin profile creation
*/
