/*
  # Fix Budget Calculation Function

  1. Changes
    - Fix the calculate_total_cost function to handle different JSONB structures
    - Ensure proper handling of opme_quotes whether it's an array or object
...
-- Drop and recreate the calculate_total_cost function with better error handling
