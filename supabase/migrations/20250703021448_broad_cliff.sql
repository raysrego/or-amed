/*
  ...
  1. Localiza o usuário pelo email na tabela auth.users
  2. Verifica se já existe um perfil na tabela user_profiles
  3. Atualiza ou cria o perfil com permissões de administrador
  
  Nota: O usuário precisa ter feito login pelo menos uma vez para aparecer na tabela auth.users
*/
