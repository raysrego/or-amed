      ...
      <html>
        ...
        <body>
          ...
          <div class="section">
            ...
            <div class="grid">
              <div>
                ${request.icu_days ? `<div class="item"><span class="label">Custos Hospital (${request.icu_days} UTI ):</span> ${formatCurrencyForPrint((budget.icu_daily_cost || 0) * request.icu_days)}</div>` : ''}
                ${request.ward_days ? `<div class="item"><span class="label">Custos Hospital (${request.ward_days} Enfermaria):</span> ${formatCurrencyForPrint((budget.ward_daily_cost || 0) * request.ward_days)}</div>` : ''}
                ${request.room_days ? `<div class="item"><span class="label">Custos Hospital (${request.room_days} Apartamento):</span> ${formatCurrencyForPrint((budget.room_daily_cost || 0) * request.room_days)}</div>` : ''}
              </div>
              <div>
